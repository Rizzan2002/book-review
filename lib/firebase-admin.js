...
console.log('[FORCE RE-BUILD V4] --- Starting lib/firebase-admin.js');
...
console.log('[DEBUG V4] Checking Vercel Environment Variables...');
console.log(`[DEBUG V4] FIREBASE_PROJECT_ID: ${process.env.FIREBASE_PROJECT_ID ? '******' : 'NOT FOUND (undefined)'}`);
console.log(`[DEBUG V4] FIREBASE_CLIENT_EMAIL: ${process.env.FIREBASE_CLIENT_EMAIL ? '******' : 'NOT FOUND (undefined)'}`);
console.log(`[DEBUG V4] FIREBASE_PRIVATE_KEY: ${process.env.FIREBASE_PRIVATE_KEY ? '******' : 'NOT FOUND (undefined)'}`);
// --- END DEBUGGING LOGS ---
...
if (!admin.apps.length) {
  try {
    ...
    db = admin.firestore();
    console.log('[DEBUG V4] Firebase admin initialized successfully.');
